...
tm_tunes="#[bg=$base00,fg=$base0D] ♫ #(osascript -l JavaScript ~/fedora_dotfiles/applescripts/tunes.js)"
# tm_tunes="#[fg=$tm_color_music]#(osascript ~/fedora_dotfiles/applescripts/tunes.scpt | cut -c 1-50)"
# tm_battery="#(~/fedora_dotfiles/bin/battery_indicator.sh)"
